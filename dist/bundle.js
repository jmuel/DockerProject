...
React.render(React.createElement(Input, null), document.getElementById('root'));


},{"./components/Input":2,"react":150}],2:[function(require,module,exports){
'use strict';
var React = require('react');
...
},{"./PrettyJSON":3,"react":150}],3:[function(require,module,exports){
'use strict';
var React = require('react');
...
var PrettyJSON = React.createClass({displayName: "PrettyJSON",
    render: function() {
        return (
            React.createElement("pre", null, JSON.stringify(this.props.value, undefined, 2))
        );
    }
})
